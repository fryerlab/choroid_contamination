...
```{r, message=FALSE}
setwd("~/TTR/02_AllenBrainAtlas/")
pdf("Allen_TTR_male_histogram.pdf", width = 4, height = 4)
h4
```
...
```{r}
#pdf("Figures/Allen_TTR_male_MDS_voom.pdf", width = 4, height = 4)
...
for (i in allComparisons) {
  ...
  #output as txt file
  path <- paste("DEGs/Allen_DEGs_TTR_male_", i, "_FDRq1_Log2FC0.txt", sep = "") 
  write.table(
    vTopTableAll,
    path,
    sep = "\t",
  ...
  path <- paste("DEGs/Allen_DEGs_TTR_male_", i, "_FDRq0.05_Log2FC1.txt", sep = "") 
  write.table(
    vTopTable2,
    path,
    sep = "\t",
...
dirty_vs_clean <-
  read.table(
    "DEGs/Allen_DEGs_TTR_male_dirty_vs_clean_FDRq1_Log2FC0.txt",
    header = TRUE,
    sep = "\t",
    stringsAsFactors = F
  )
...
```{r}
setwd("~/TTR/02_AllenBrainAtlas/")
pdf("Figures/Allen_TTR_male_volcano.pdf", width = 4, height = 4)
p
```
